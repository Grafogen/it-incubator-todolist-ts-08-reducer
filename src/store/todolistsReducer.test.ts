import {
    AddTodolistAC,
    ChangeTodolistFilter, ChangeTodolistTypeAC,
...
test('correct todolist should change its name', () => {
    ...
    const action:ChangeTodolistTypeAT = {
    ...
    const endState = todolistsReducer(startState, ChangeTodolistTypeAC(todolistId2,newTodolistTitle))
